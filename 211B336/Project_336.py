...
class bus_booking:
    ...
    def home_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 20 bold', bg='cyan', fg='royal blue').grid(row=2,
                                                                                                            column=2,
                                                                                                            columnspan=9,
                                                                                                            padx=w // 2.5)
    ...
    def cover_page(self):
        ...
        Label(root, text="Online Bus Booking System", font='Arial 20 bold', bg='cyan', fg='royal blue').pack()
        Label(root, text="\n\n\n\n\nName: Vaibhav Gupta", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nER No. : 211B336", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nMobile : 8003879840\n\n\n\n", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="Submitted to: Dr. Mahesh Kumar", font='Arial 15 bold', bg='cyan', fg='royal blue').pack()
